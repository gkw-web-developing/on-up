...
export default function AddToCartForm({}: Props) {
  return (
    <form className='flex w-fit'>
      <input className='rounded-tl-lg rounded-bl-lg border border-r-0 border-neutral-200 outline-none py-2 px-4 w-20 bg-white' type="number" min="1" defaultValue={1}/>
